...
DROP TABLE IF EXISTS BATCH_REMOTE_CHUNK_EXECUTION_IMPORT_RANDOM_USER;

CREATE TABLE BATCH_REMOTE_CHUNK_EXECUTION_IMPORT_RANDOM_USER  (
...
ALTER TABLE BATCH_REMOTE_CHUNK_EXECUTION_IMPORT_RANDOM_USER ADD INDEX STEP_EXECUTION_ID_STATUS(STEP_EXECUTION_ID, SEQUENCE);
